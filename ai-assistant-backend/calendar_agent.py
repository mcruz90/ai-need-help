...
def calendar_agent(user_message, chat_history, additional_context) -> dict:
        """
        This function is used to handle the user's message and generate a response using the calendar agent.
        ...
        return: The final response generated by the calendar agent. 
        """
